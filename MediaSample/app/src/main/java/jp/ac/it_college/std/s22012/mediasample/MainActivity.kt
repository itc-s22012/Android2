package jp.ac.it_college.std.s22012.mediasample
...
import jp.ac.it_college.std.s22012.mediasample.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mediaFileUri = Uri.parse(
             "android.resource://${packageName}/${R.raw.sound}"
        )
        mediaPlayer?.apply {
        ...
        binding.tbBack.setOnClickListener(::onBackButtonClick)
